...
const messages = {
  en: {
    ...
    reports: {
      ...
      monthlyRainfall: "Monthly Rainfall",
      tempAnomaly: "Temperature Anomaly vs. Historical Average",
      anomaly: "Anomaly",
  ...
  it: {
    ...
    reports: {
      title: "Report Climatici",
      noData: "Nessun dato disponibile per quest'anno.",
      avgTemp: "Temp Media",
      maxTemp: "Temp Max",
      minTemp: "Temp Min",
      totalRain: "Pioggia Totale",
      maxGust: "Raff Max",
      avgPressure: "Press Media",
      temperatureTrend: "Andamento Temperatura",
      monthlyRainfall: "Pioggia Mensile",
      tempAnomaly: "Anomalia Temperatura vs. Media Storica",
      anomaly: "Anomalia",
